#include "processrotatecw90task.h"

ProcessRotateCW90Task::ProcessRotateCW90Task(int taskId, QObject *receiver)
    : m_taskId(taskId), m_receiver(receiver)
{
    setAutoDelete(true); // Автоматическое удаление после выполнения
}

void ProcessRotateCW90Task::run()
{
...
//    }
    ...
    QString qsInfoMessage0 = "==execRotateCW90==";
            ...
            //---
                ...
                if((Progress < 100)&&(!(Progress % 5)))
                {
                    QMetaObject::invokeMethod(
                                m_receiver, "updateProgressRotateCW90Task",
                                Qt::QueuedConnection,
                                Q_ARG(int, Progress));
                }
            //---
